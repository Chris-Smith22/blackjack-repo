...
class Game:
    ...
    def __init__(self, num_of_players, players, dealer, num_of_decks, min_bet, max_bet):

        self.num_of_players = num_of_players #1 for now, can change later, ask user for input
